    ...
    <ul className={classes.NavigationItems}>
        ...
        <span className={classes.dropdown}>SISTEMI TEHNICKE ZASTITE <i className="fa fa-caret-down"></i>
            <div className={classes.dropdownContent}>
                ...
                <NavigationItem link="/parking-rampe" navClickedHandler={props.navClickedHandler}>PARKING RAMPE MOTORI ZA KAPIJE I PESACKE BARIJERE</NavigationItem>


                <NavigationItem link="/kontrola-sluzbenika-obezbedjenja" navClickedHandler={props.navClickedHandler}>SISTEMI ZA KONTROLU POSTOJECIH SLUZBENIKA OBEZBEDJENJA</NavigationItem>
                ...
                <NavigationItem link="/iso" navClickedHandler={props.navClickedHandler}>I.S.O. INTEGRISANI SISTEMI OBEZBEDJENJA</NavigationItem>
            </div>
        </span>
