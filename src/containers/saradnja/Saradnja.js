                ...
                <div className={[classes.ONamaHeader, 'ws-header'].join(' ')}>
                    ...
                    <div
                        ...
                        <div className=" ws-box">
                            <p><span className="ws-txt-bold">BUDUĆNOST</span>
                            </p>
                ...
                <div className={[classes.Saradnja, 'ws-body'].join(' ')}>
                    ...
                    <div className={[classes.DeoTima, 'ws-simple-style-cont ws-politika-sistema'].join(' ')}>
                        <div className={[classes.MarginTop, 'container'].join(' ')}>
                            <div className="ws-box">
                                <h4 className="ws-txt-bold">Postanite deo Watchout Security tima</h4>
                                <p>Konstantno smo u potrazi za novim kolegama koji će se priključiti Watchout Security
                                    ...
                                    bezbednosti i zadovoljstva naših klijenata.</p><br/>
                                <p>Ukoliko želite da razvijate karijeru u jednoj od najperspektivnijih delatnosti
                                    ...
                                    lica, imovine i poslovanja, procene rizika.</p> <br/>
                                ...
                                <ul className="ws-licence-list">
                                    <li>Obavljajući poslove iz nadležnosti privatnog obezbeđenja, zaposleni se susreću
                                        sa zadacima koji iziskuju posebne kvalitete i osobine neohpodne da se uspešno
                                        odgovori visokim zahtevima ovog posla.
                                    </li>
                    ...
                    <div className={[classes.Partner, 'ws-simple-style-cont ws-politika-sistema'].join(' ')}>
                        <div className={[classes.MarginTop, 'container'].join(' ')}>
                            <div className="ws-box">
                                ...
                                <p className="ws-txt-bold">Kroz naš rad u oblasti privatnog obezbedjenja činimo
                                    bezbedniji život miliona ljudi širom Srbije.</p><br/>
                                <p>Sarađujemo sa velikim brojem različitih organizacija u Srbiji kojima preko naših
                                    ...
                                    poslovanja.</p><br/>
                                <p>Uspeh naših partnera čini saradnju sa nama još korisnijom.</p>
                                <br/>
                                <p className="ws-txt-bold">Želite da nam se pridružite?</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className={[classes.MarginTop, 'container'].join(' ')}>
                            <div className="ws-box">
                                ...
                                <p className="ws-txt-bold">Razmišljate da krenete putem preduzetništva, a nemate
                                    sopstvenu poslovnu ideju?
                                    Želite da uđete u već oprobani poslovni model, gde poznat security brend i sva
                                    znanja o preduzetništvu dobijete „na ruke“?</p> <br/>
                                <p>Watchout security je prva privatna security kompanija u Srbiji koja zastupa franšizni
                                ...
                                <p>Ujedno Vam želimo predstaviti naše usluge, koje smo osmislili sa ciljem, da Vama kao
                                    ...
                                    preduzetnik.</p>
                                <br/>
                                <p>Ako ste zainteresovani da poslujete pod watchout security franšizom potrebno je
                                ...
                                <p>Pozivamo Vas, da nas kontaktirate na <span className={[classes.Assertive]}>fransiza@ws.co.rs</span> ili na telefonske brojeve <span className={[classes.Assertive]}>+381
                                    69 558 58 01</span> i <span className={[classes.Assertive]}>+381 69 558 58 02</span> (Vladimir i Milutin Jaćimović, direktori).</p>
                                <br/>
