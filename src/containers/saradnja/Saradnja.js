...
class Saradnja extends Component {
    ...
    render() {
        ...
        return (
            <Aux>
                <div className={[classes.ONamaHeader, 'ws-header ws-page-saradnja'].join(' ')}>
                ...
                <div className={[classes.Saradnja, 'ws-body ws-page-saradnja'].join(' ')}>
                    ...
                    <div className={[classes.DeoTima, 'ws-simple-style-cont ws-politika-sistema'].join(' ')}>
                        <div className={[classes.MarginTop, 'container'].join(' ')}>
                            <div className="ws-box">
                                ...
                                <p>Konstantno smo u potrazi za novim kolegama koji će se priključiti Watchout
                                    Security
                                    timu i svojim znanjem i veštinama doprneti daljem razvoju kompanjije i rastu
                                    stepena
                                ...
                                <p>Ukoliko želite da razvijate karijeru u jednoj od najperspektivnijih delatnosti
                                    ...
                                    Zapošljavamo stručne kadrove u oblasti, fizičkog i tehničkog obezbeđenja u
                                    zaštiti
                                    lica, imovine i poslovanja, procene rizika.</p>
                                <br/>
                                <p>Pošaljite nam vašu radnu biografiju na <a
                                    href="mailto:hr.watchout@gmail.com?Subject=Radna%20biografija"
                                    target="_blank">hr.watchout@gmail.com</a> i kolege iz HR sektora
                                ...
                                <ul className="ws-licence-list">
                                    <li>Rešenost da sve svoje sposobnosti i profesionalna znanja ulože u posao
                                        zaštite
                                    ...
                                    <li>Visoke intelektualne sposobnosti, širina i nivo obrazovanja koji će im
                                        omogućiti
                                        da izađu na kraj sa složenošću svakodnevnih zadataka i pružiti izvesnu
                                        prednost
                                    ...
                                    <li>Odvažnost da se uhvate u koštac sa nekim od najznačajnijih pitanja sa kojima
                                        se
                                    ...
                                    <li>Samopouzdanje, poverenje u sopstvene kapacitete i kompetenciju, ali i
                                        spremnost
                                    ...
                                    <li>Socijalne veštine i sposobnosti za rad sa ljudima: komunikativnost,
                                        rečitost,
                                        ubedljivost, prodornost i medju najvažnijim, veština slušanja, u poslovima
                                        čiji
                        ...
                        <div className={[classes.MarginTop, 'container'].join(' ')}>
                            <div className="ws-box">
                                ...
                                <p className="ws-txt-bold">Ukoliko ste firma koja na lokalnom nivou pruža usluge
                                    ...
                                    dodatno da zaradite kroz širenje tržišta, asortimana usluga i korišćenja
                                    postojećih
                                    poslovnih veza, onda je pravo rešenje partnerstvo sa nama..... Bez mnogo
                                    uloženog
                                    ...
                                    zadovoljnijim, a kao posledica javiće se uvećan profit. Pored postojećih usluga
                                    koje
                                ...
                                <p>Treba nam bar jedna ili dve rečenice za nekog ko nema firmu a želi da prodaje ili
                                    ...
                                    iskustva…</p><br/>
                                <p>Kroz naš rad u oblasti privatnog obezbedjenja činimo bezbedniji život miliona
                                    ljudi
                                    širom Srbije.
                                    Sarađujemo sa velikim brojem različitih organizacija u Srbiji kojima preko naših
                                    globalnih mreža, iskustva i poverenja pomažemo da ostvare svoje ciljeve. Kada su
                                    u
                                    pitanju poslovni partneri, u potpunosti razumemo njihovu društvenu odgovornost i
                                    marketinške strategije. Isto tako, cenimo težnje naših partnere iz javnog i
                                    trećeg
                                    sektora za usavršavanjem i njihove aspiracije u oblasti obezbeđenja lica,
                                    imovine i
                                    poslovanja.</p><br/>
                                <p>Uspeh naših partnera čini saradnju sa nama još korisnijom, zato Vam predlažemo da
                                    nas
                                    kontaktirate i time započnete novu eru u Vašem poslovanju..Ukoliko ste firma
                                    koja na
                                    ...
                                    usluga i korišćenja postojećih poslovnih veza, onda je pravo rešenje partnerstvo
                                    sa
                                    nama..... Bez mnogo uloženog truda, sa korišćenjem naših resursa i potpuno
                                    usaglašenim rešenjima sa aktuelnom zakonskom regulativom, imaćete mogućnost da
                                    Vaše
                                    postojećih kupce učinite zadovoljnijim, a kao posledica javiće se uvećan profit.
                                    Pored postojećih usluga koje pružate možete da ponudite još više od 20
                                    različitih
                                    usluga iz domena fizičko-tehničke zaštite...</p><br/>
                                <p>Kroz naš rad u oblasti privatnog obezbeđenja činimo život miliona ljudi širom
                                    Srbije
                                    bezbednijim.
                                    Sarađujemo sa velikim brojem različitih organizacija u Srbiji kojima preko naših
                                    globalnih mreža, iskustva i poverenja pomažemo da ostvare svoje ciljeve. Kada su
                                    u
                                    pitanju poslovni partneri, u potpunosti razumemo njihovu društvenu odgovornost i
                                    marketinške strategije. Isto tako, cenimo težnje naših partnera iz javnog i
                                    trećeg
                                    sektora za usavršavanjem i njihove aspiracije u oblasti obezbeđenja lica,
                                    imovine i
                                    poslovanja.</p><br/>
                    ...
                    <div
                        className={[classes.KorisnikFransize, 'ws-simple-style-cont ws-politika-sistema'].join(' ')}>
                        <div className={[classes.MarginTop, 'container'].join(' ')}>
                            <div className="ws-box">
                                ...
                                <p className="ws-txt-bold">Razmišljate da krenete putem preduzetništva, a nemate
                                    sopstvenu poslovnu ideju? Želite da uđete u već oprobani poslovni model, gde
                                    poznat
                                    security brend i sva znanja o preduzetništvu dobijete „na ruke“?</p> <br/>
                                <p><b>Watchout Security</b> je prva privatna security kompanija u Srbiji koja
                                    zastupa
                                    franšizni
                                    sistem. Franšiza, partnerski sistem ili zastupništvo su način da započnete
                                    sopstveni
                                    biznis. Ovakav biznis vam donosi nezavisnost u poslovanju i mogućnost
                                    zadovoljavajuće zarade.</p>
                                <br/>
                                <p>Ujedno Vam želimo predstaviti naše usluge, koje smo osmislili sa ciljem, da Vama
                                    kao
                                    potencijalnom korisniku franšize sveobuhvatno pomognemo da uspete kao
                                    preduzetnik.</p>
                                <br/>
                                <p>Ako ste zainteresovani da poslujete pod <b>Watchout Security</b> franšizom
                                    potrebno
                                    je
                                    odgovoriti na nekoliko ključnih pitanja, stoga Vas pozivamo u sedište
                                    organizacije
                                    na besplatni savet. Konsultacija je besplatna i potpuno neobavezujuća za Vas.
                                </p>
                                <br/>

                                <h5 className="ws-txt-bold">Konsultacije sa našim zastupnicima u oblasti franšizinga
                                    Vam
                                    mogu pomoći:</h5>

                                <ul className="ws-licence-list">
                                    <li>Da lakše ocenite koje su prednosti i potencijali franšiznog sistema za Vas,
                                        kao
                                        vlasnika franšize
                                    </li>
                                    ...
                                    <li>Da postanete svesni šta je potrebno za uspostavljanje solidnog, odlično
                                        realizovanog i samim tim uspešnog franšiznog sistema, čiji deo ćete postati
                                        ( u
                                        vezi toga, šta su obaveze korisnika franšize prema Vama, i šta je, Vaše
                                        pravo)
                                    </li>
                                ...
                                <p>Pozivamo Vas, da nas kontaktirate na <a
                                    href="mailto:fransiza@ws.co.rs?Subject=Fransiza" target="_blank"><span
                                    class="ws-font-color-assertive">fransiza@ws.co.rs</span></a> ili na telefonske
                                    brojeve <a href="tel:+381695585801" class="ws-font-color-assertive">+381
                                        69 558 58 01</a> i <a href="tel:+381695585802"
                                                              class="ws-font-color-assertive">+381 69 558 58
                                        02</a> (Vladimir i Milutin
