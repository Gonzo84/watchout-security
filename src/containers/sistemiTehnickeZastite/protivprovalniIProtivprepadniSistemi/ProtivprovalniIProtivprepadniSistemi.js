...
import protivprovalniIProtivprepadniSistemiImg from '../../../assets/images/sistemiTehnickeZastite/protivprovalniIProtivprepadniSistemi.jpg'


class ProtivprovalniIProtivprepadniSistemi extends Component {

    render() {
        window.scrollTo(0, 0);
        const headerConfig = {
            backgroundImg: protivprovalniIProtivprepadniSistemiImg,
            title: 'PROTIVPROVALNI I PROTIVPREPADNI SISTEMI',
...
export default ProtivprovalniIProtivprepadniSistemi;